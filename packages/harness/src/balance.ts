...
function bilgingBalanceOf(block: Record<string, unknown>): BilgingBalance {
  return {
    ...
    comboScalePerMilleByStarLevel: integerArrayOf(block, 'comboScalePerMilleByStarLevel'),
    ...
    aboveWaterFallTicksPerCell: integerOf(block, 'aboveWaterFallTicksPerCell'),
    belowWaterFallTicksPerCell: integerOf(block, 'belowWaterFallTicksPerCell'),
